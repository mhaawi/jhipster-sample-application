...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(io.github.jhipster.application.domain.NotificationDefination.class.getName() + ".applicationNames", jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.NotificationDefination.class.getName() + ".apiKeys", jcacheConfiguration);
