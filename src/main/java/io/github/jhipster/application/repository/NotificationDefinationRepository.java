...
public interface NotificationDefinationRepository extends JpaRepository<NotificationDefination, Long> {
    ...
    @Query(value = "select distinct notification_defination from NotificationDefination notification_defination left join fetch notification_defination.apiDefinations",
    ...
    @Query("select notification_defination from NotificationDefination notification_defination left join fetch notification_defination.apiDefinations where notification_defination.id =:id")
