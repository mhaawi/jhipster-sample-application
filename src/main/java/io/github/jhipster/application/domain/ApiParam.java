...
public class ApiParam implements Serializable {
    ...
    public ApiDefination getApiKey() {
        return apiKey;
    }

    public ApiParam apiKey(ApiDefination apiDefination) {
        this.apiKey = apiDefination;
        return this;
    }

    public void setApiKey(ApiDefination apiDefination) {
        this.apiKey = apiDefination;
    }
