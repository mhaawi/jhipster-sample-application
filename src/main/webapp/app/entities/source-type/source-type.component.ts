...
export class SourceTypeComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.sourceTypeService
            ...
            .subscribe(
                (res: HttpResponse<ISourceType[]>) => this.paginateSourceTypes(res.body, res.headers),
    ...
    trackId(index: number, item: ISourceType) {
        return item.id;
    }
    ...
    protected paginateSourceTypes(data: ISourceType[], headers: HttpHeaders) {
