...
import { SourceTypeComponent } from 'app/entities/source-type/source-type.component';
...
describe('Component Tests', () => {
    describe('SourceType Management Component', () => {
        let comp: SourceTypeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SourceTypeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.sourceTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
