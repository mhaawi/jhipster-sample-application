...
import { ApiParamComponent } from 'app/entities/api-param/api-param.component';
...
describe('Component Tests', () => {
    describe('ApiParam Management Component', () => {
        let comp: ApiParamComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ApiParamComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.apiParams[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
